...
SkyBoxShadowMapShader::SkyBoxShadowMapShader(std::string Name, Renderer& rdr, 
	const std::wstring& path, const std::vector<Renderer::RootParaType>& rootParas)
	: ShadowMapShader(Name, rdr, path, rootParas)
{
}

void SkyBoxShadowMapShader::CreatePipelineState(Renderer& rdr)
{
